...
namespace Core
{
    public static class CollisionController
    {
        ...
        public static int GetCollidedBodyPartId(Vector2 previous,Vector2 current, HitBox[] bodyParts)
        {
            bool success = false;
            ...
            return Helps.BodyPartIsNull;
        }
        #endregion
        #region Private methods
        private static Vector2[] GetRealPoints(HitBox bodyPart)
        {
